...
echo "🔧 Applying quick fixes for 502 Bad Gateway..."
...
# Check if server-production.js exists
if [ ! -f "server-production.js" ]; then
    echo "❌ server-production.js not found. Creating it..."
    
    # Create a simple server-production.js
...
curl -s http://localhost:3000/api/health && echo "✅ API is working!" || echo "❌ API not responding"
